...
public class DistributedQueueDemo {
    ...
    public static void main(String[] args) throws Exception {
        CuratorFramework clientA = CuratorFrameworkFactory.newClient("192.168.130.230:2181", new ExponentialBackoffRetry(1000, 3));
        clientA.start();
        CuratorFramework clientB = CuratorFrameworkFactory.newClient("192.168.130.230:2181", new ExponentialBackoffRetry(1000, 3));
        clientB.start();
