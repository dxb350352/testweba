package com.dxb.test.springbatch.batch;

import com.dxb.test.springbatch.listener.JobListener;
import com.dxb.test.springbatch.model.Access;
...
//                next(xxxStep()).
    ...
    public ItemReader<? extends Access> getDataReader() {
        ...
        log.info("getDataReader data111111111111111111111111111111 : ");
        return reader;
    }
